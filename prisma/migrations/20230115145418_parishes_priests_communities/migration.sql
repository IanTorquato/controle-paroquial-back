...
-- AddForeignKey
ALTER TABLE "priests" ADD CONSTRAINT "priests_currentParishId_fkey" FOREIGN KEY ("currentParishId") REFERENCES "parishes"("id") ON DELETE SET NULL ON UPDATE CASCADE;
